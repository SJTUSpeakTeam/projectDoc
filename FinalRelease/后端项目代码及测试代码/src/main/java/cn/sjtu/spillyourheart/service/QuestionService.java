...
public interface QuestionService {
    ...
    Msg getNotDeletedQuestions(JSONObject object);
    Msg getHotQuestions();
    Msg getNewQuestions();
    Msg getFilterQuestions(JSONObject object);
    Msg getUserQuestions(Integer beginQuestionId,Integer userId);
    Msg getUserAnswerQuestions(Integer beginQuestionId,Integer userId);
    Msg getUserCollectQuestions(Integer beginQuestionId,Integer userId);
