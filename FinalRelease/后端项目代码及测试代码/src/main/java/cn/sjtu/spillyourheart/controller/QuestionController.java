...
public class QuestionController {
    ...
    @RequestMapping("/getAdminQuestions")
    @UserToken
    @UserAdmin
    public Msg getAdminQuestions(@RequestBody JSONObject object){ return questionService.getNotDeletedQuestions(object); }
    ...
    @RequestMapping("/getUserAnswerQuestions")
    @UserToken
    @UserValid
    public Msg getUserAnswerQuestions(@RequestParam("beginQuestionId") int beginQuestionId,@RequestParam("userId") int userId){
        return questionService.getUserAnswerQuestions(beginQuestionId,userId);
    }


    @RequestMapping("/getUserCollectQuestions")
    @UserToken
    @UserValid
    public Msg getUserCollectQuestions(@RequestParam("beginQuestionId") int beginQuestionId,@RequestParam("userId") int userId){
        return questionService.getUserCollectQuestions(beginQuestionId,userId);
    }
