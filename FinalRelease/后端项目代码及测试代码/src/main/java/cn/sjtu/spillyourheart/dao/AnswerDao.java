...
public interface AnswerDao {
    ...
    boolean bannedOne(Integer answerId); //one is ban or not
    ...
    List<Answer> getUserAnswersOrderByQuestionId(Integer beginQuestionId,Integer userId);
    List<Answer> getDeletedList(Integer beginAnswerId,String search);
    List<Answer> getBannedList(Integer beginAnswerId,String search);
    List<Answer> getAllList(Integer beginAnswerId,String search);
    ...
    void ban(Integer answerId);
    void unban(Integer answerId);
}
