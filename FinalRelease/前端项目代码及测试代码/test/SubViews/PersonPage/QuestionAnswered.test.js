...
import QuestionAnswered from "../../../src/SubViews/PersonPage/QuestionAnswered";
...
describe('QuestionAnswered', () => {
    ...
    it('测试',async ()=>{
        ...
        const wrapper = shallow(<QuestionAnswered aimUser={aimUser}/>)
        wrapper.instance().fetchNickname();
        await flushPromises();
        wrapper.update();
        wrapper.instance().getQuestionAnswered();
        await flushPromises();
        wrapper.update();
