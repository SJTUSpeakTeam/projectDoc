...
* #### 分区获取 ×
```matlab
Request: GET /getPartition
Parameters: partitionId(integer)
...
* #### 分区删除 ×
```matlab
Request: DELETE /deletePartition
Body: {
    *partitionId: integer
}
...
* #### 多个分区删除 ×
```matlab
Request: DELETE /deletePartitions
Body: {
    *partitionId: [integer,...]
}
