                    ...
                    <div className="row">
                        <div className="col-12">
                            ...
                            <div style={{width:"100%",marginTop:"20px"}}>
                                <div style={{width:"50%",float:"left"}}>
                                    <h2 className="title title--h3" style={{marginTop:"20px"}}>邮箱</h2>
                                    <Input value={this.state.mailAddr} allowClear onChange={this.mailAddrChange}
                                           placeholder={"邮箱"} style={{width:"200px"}}/>
                                </div>

                                <div style={{width:"50%",float:"right"}}>
                                    <h2 className="title title--h3" style={{marginTop:"20px"}}>联系方式</h2>
                            ...
                            <div style={{width:"100%"}}>
                                <div style={{width:"100%",float:"left"}}>
                                    <h2 className="title title--h3" style={{marginTop:"20px"}}>个人简介</h2>
