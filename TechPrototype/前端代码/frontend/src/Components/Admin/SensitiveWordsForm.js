...
import {Table, Tag, Space, Divider, Input, Select,Button,Form} from 'antd';
...
class SensitiveWordsForm extends React.Component{
    ...
    selectRow = (record) => {
        ...
        console.log("is changing ",selectedRowKeys);
        ...
        console.log("change to",selectedRowKeys);
        this.setState({
            selectedRowKeys:selectedRowKeys,
        });
    ...
    render() {
        ...
        const rowSelection = {
            ...
            onChange: (selectedRowKeys, selectedRows) => {
                // console.log("selec",selectedRowKeys);
